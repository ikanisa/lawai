...
const packageManager = packageJson.packageManager || 'pnpm@8.15.4';
const pnpmVersion = packageManager.split('@')[1]?.split('+')[0] || '8.15.4';
...
if (!userAgent.startsWith('pnpm/')) {
  ...
  console.error(`  2. Activate pnpm ${pnpmVersion}:`);
  console.error('     \x1b[36m%s\x1b[0m', `corepack prepare pnpm@${pnpmVersion} --activate`);

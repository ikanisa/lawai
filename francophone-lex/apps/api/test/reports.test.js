...
import { buildRetrievalMetricsResponse, summariseCepej, summariseRuns, summariseHitl, summariseIngestion, summariseEvaluations, summariseSlo, buildTransparencyReport, mapLearningReports, } from '../src/reports.js';
describe('reports helpers', () => {
    ...
    it('maps learning reports with safe payload fallbacks', () => {
        ...
        const mapped = mapLearningReports(rows);

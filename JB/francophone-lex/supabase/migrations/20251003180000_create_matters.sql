...
drop trigger if exists set_matters_updated_at on public.matters;
...
drop trigger if exists set_matter_deadlines_updated_at on public.matter_deadlines;
...
drop trigger if exists set_matter_documents_updated_at on public.matter_documents;

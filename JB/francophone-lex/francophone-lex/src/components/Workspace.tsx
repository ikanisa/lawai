...
import { CitationsBrowser } from "./CitationsBrowser";
import { MatterManagement } from "./MatterManagement";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { Button } from "@/components/ui/button";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { Clock, FileText, AlertTriangle, TrendingUp, Globe, Scale, Upload, BookOpen, Folder } from "lucide-react";
...
export function Workspace() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Navigation Tabs */}
      <div className="sticky top-0 z-40 glass-surface border-b border-glass-border safe-top">
        <div className="container mx-auto px-4">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="glass-surface border-0 w-full justify-start overflow-x-auto">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <Card className="glass-surface">
                ...
                <CardContent className="space-y-4">
                  {[
                    ...
                    <div key={index} className="flex items-center justify-between p-4 rounded-lg border border-glass-border hover-scale">
        ...
        <TabsContent value="documents" className="mt-0">
          <div className="px-4 py-8">
            <div className="container mx-auto max-w-4xl">
              <DocumentUpload onUpload={(files) => console.log("Files uploaded:", files)} />
            </div>
          </div>
        </TabsContent>

...
create policy if not exists "governance publications read" on public.governance_publications
  for select using (true);

create policy if not exists "governance publications service write" on public.governance_publications

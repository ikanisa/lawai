import { z } from 'zod';
export const SUMMARISATION_CLIENT_TAGS = {
    cacheKeySuffix: 'summaries',
    requestTags: process.env.OPENAI_REQUEST_TAGS_SUMMARIES ??
...
export const LEGAL_DOCUMENT_SUMMARY_JSON_SCHEMA = {
    ...
    schema: {
        ...
        properties: {
            summary: {
                type: 'string',
                description: "Résumé exécutif en français (3 à 5 phrases) mettant en avant l’objet, la portée et les dates clés du document.",
            },
            highlights: {
                type: 'array',
                minItems: 1,
...
export function parseLegalDocumentSummaryPayload(payload) {

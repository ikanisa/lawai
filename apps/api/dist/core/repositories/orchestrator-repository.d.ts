import type { DirectorCommandInput, OrchestratorCommandEnvelope, OrchestratorCommandRecord, OrchestratorCommandResponse, OrchestratorJobRecord, OrgConnectorRecord, SafetyAssessmentResult } from '@avocat-ai/shared';
...
export interface OrchestratorAIGateway {
    runSafetyAssessment(envelope: OrchestratorCommandEnvelope, logger?: OrchestratorLogger): Promise<SafetyAssessmentResult>;
}

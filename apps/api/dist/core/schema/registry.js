...
export function generateSchemaTypes({ outputPath = join(process.cwd(), 'src/core/schema/registry-types.d.ts'), banner = '// AUTO-GENERATED BY schema:generate. DO NOT EDIT.\n', } = {}) {
    const chunks = [banner, "import type { z } from 'zod';\n\n"];

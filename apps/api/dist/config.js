...
import { loadServerEnv, } from '@avocat-ai/shared';
const envSchema = z
    .object({
    ...
    const requiredKeys = ['WA_TOKEN', 'WA_PHONE_NUMBER_ID', 'WA_TEMPLATE_OTP_NAME'];
...
function assertProductionEnv(e) {
...
export function loadAllowlistOverride() {

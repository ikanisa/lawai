export function buildPhaseCWorkspaceDesk() {
    return {
        playbooks: [
            {
                id: 'fr-civil-claim',
                ...
                jurisdiction: 'FR',
                mode: 'ask',
                summary: 'Guide litigators through FR civil claim intake with FRIA evidence, CEPEJ charter checks, and OHADA override handling before drafting filings.',
                regulatoryFocus: [
            ...
            },
            {
                ...
                jurisdiction: 'OHADA',
                mode: 'do',
                summary: 'Structure debt recovery under AUSCGIE with statute alignment, Maghreb residency flags, and political risk overlays.',
                regulatoryFocus: [
...
export function buildPhaseCProcessNavigator() {
    return [
        {
            id: 'fr-civil-claim',
            ...
            mode: 'ask',
            summary: 'Prépare l’assignation civile avec ingestion FRIA, attestations CEPEJ et revue OHADA avant dépôt.',
            estimatedMinutes: 45,
            ...
            steps: [
                {
                    ...
                    description: 'Importer le dossier FRIA, enregistrer le consentement CEPEJ et vérifier les engagements Conseil de l’Europe.',
                    state: 'complete',
                ...
                },
                {
                    ...
                    description: 'Évaluer les pièces jointes, appliquer les bannières langue Maghreb et confirmer la résidence des données.',
                    state: 'complete',
                ...
                },
                {
                    ...
                    description: 'Exécuter les scénarios CEPEJ et journaliser les attestations EU AI Act pour le Go/No-Go.',
                    state: 'in_progress',
                ...
                },
                {
                    ...
                    description: 'Assembler le brouillon de l’assignation avec sources statutaires et citations OHADA.',
                    state: 'in_progress',
                ...
                },
                {
                    ...
                    description: 'Acheminer la version finale vers la file HITL et capturer la validation avant dépôt tribunal.',
                    state: 'blocked',
        ...
        },
        {
            ...
            mode: 'do',
            summary: 'Structure la mise en demeure OHADA avec priorisation AUSCGIE, graphes de traitement CCJA et signaux politiques.',
            estimatedMinutes: 35,
            ...
            steps: [
                ...
                },
                {
                    id: 'treatment-graph',
                    label: 'Graphes CCJA',
                    description: 'Générer le graphe de traitement CCJA avec pondération temporelle et détecter les dérives récentes.',
                    state: 'complete',
                ...
                },
                {
                    ...
                    description: 'Appliquer les alertes politiques Maghreb/CEMAC et journaliser les signaux négociation.',
                    state: 'in_progress',
        ...
        },
        {
            ...
            persona: 'bench_memo',
            mode: 'review',
            summary: 'Crée un mémo de licenciement économique avec analyse IRAC, obligations sociales et suivi HITL.',
            estimatedMinutes: 50,
        ...
        },
        {
            ...
            persona: 'procedural_navigator',
            mode: 'do',
            summary: 'Guide la constitution d’une SARL OHADA avec statuts bilingues, registres UEMOA et contrôles de résidence.',
            estimatedMinutes: 60,
        ...
        },
        {
            ...
            mode: 'ask',
            summary: 'Assemble les baux commerciaux avec obligations bilingues, vérification résidence et contrôles C2PA.',
            estimatedMinutes: 32,

...
export function cloneVoiceConsoleContext() {
    return JSON.parse(JSON.stringify(voiceConsoleContext));
}
export function buildVoiceRunResponse(request) {
    ...
    const effectiveCitations = selectedCitations.length
        ? selectedCitations

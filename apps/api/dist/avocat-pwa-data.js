export const researchDeskContext = {
    plan: {
        id: 'plan-helio-contrat',
        title: 'Analyse de la responsabilité contractuelle',
        jurisdiction: 'OHADA · Tribunal de commerce Dakar',
        riskLevel: 'MED',
        riskSummary: "Niveau de risque modéré : divergence sur la compétence OHADA et clauses limitatives de responsabilité",
        steps: [
            {
                id: 'step-intake',
    ...
    defaultCitations: [
        {
            ...
            type: 'Officiel',
            snippet: "Les commerçants sont tenus de respecter les obligations issues des contrats conclus dans l'exercice de leur commerce.",
            score: 92,
            date: '2024-01-15',
        },
        {
            ...
            type: 'Consolidé',
            snippet: 'Sont réputés actes de commerce toutes les opérations d\'intermédiaire pour le commerce de biens mobiliers.',
            score: 88,
            date: '2024-01-01',
        },
        {
            ...
            type: 'Jurisprudence',
            snippet: "La clause limitative de responsabilité ne peut faire échec à l'obligation essentielle du débiteur sans stipulation expresse.",
            score: 84,
            date: '2022-10-04',
        },
    ],
...
export const researchAnswerChunks = [
...
export const webSearchModes = ['allowlist', 'broad'];
export const defaultWebSearchMode = 'allowlist';
...
export const corpusDashboardData = {
    allowlist: [
        {
            id: 'legifrance',
            name: 'Légifrance',
...
const voiceCitations = [
    {
        ...
        snippet: "En cas d'urgence, les juridictions peuvent ordonner toutes mesures nécessaires pour éviter un dommage imminent.",
    },
    {
        ...
        snippet: "Le président peut fixer un calendrier accéléré et convoquer les parties en référé pour les mesures conservatoires.",
    },
    {
...
export const voiceConsoleContext = {
    suggestions: [
    ...
    recentSessions: [
        {
            ...
            durationMs: 54000,
            transcript: "Synthèse de la réunion Banque Helios : besoin d'une mesure conservatoire CCJA et de notifier le DPO.",
            summary: 'Mesures conservatoires proposées avec rappel des obligations OHADA et articulation avec la loi française.',
        ...
        },
        {
            ...
            durationMs: 48000,
            transcript: "Incident cybersécurité Rwanda : vérifier les obligations de notification et préparer un plan de réponse.",
            summary: 'Plan d’alerte immédiat avec rappel des obligations ICT Law Rwanda et proposition d’activation du mode confidentiel.',
...
export function buildVoiceRunResponse(transcript) {
    ...
    const intents = voiceQuickIntents.map((intent) => {
        if (intent.id === 'intent_deadline' && urgency) {
            return { ...intent, status: 'running', detail: 'Calcul express des délais de référé demandé.' };
        }
    ...
    return {
        ...
        intents,
        readback: (selectedCitations.length ? selectedCitations : voiceCitations.slice(0, 2)).map((citation) => `${citation.label} — ${citation.snippet}`),
        riskLevel: urgency ? 'HIGH' : compliance ? 'MED' : 'LOW',
        clarifications,
    };
}
export const uploadAllowlist = corpusDashboardData.allowlist;
export const ohadaHighlights = citationsData.ohadaFeatured;

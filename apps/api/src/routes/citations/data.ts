      ...
      content: [
        {
          ...
          heading: 'Principes',
          text:
            "Les fournisseurs de services numériques doivent garantir la confidentialité et l'intégrité des données...",
        },
        {
          anchor: 'obligations',
          heading: 'Obligations',
...
export function cloneCitationsData(): CitationsBrowserData {
  return JSON.parse(JSON.stringify(citationsData)) as CitationsBrowserData;
}

export function getCitationById(id: string): CitationDocument | undefined {

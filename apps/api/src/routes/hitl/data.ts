import { HitlQueueDataSchema, type HitlQueueData } from '@avocat-ai/shared';
...
export function cloneHitlQueueData(): HitlQueueData {
  return JSON.parse(JSON.stringify(hitlQueueData)) as HitlQueueData;
}

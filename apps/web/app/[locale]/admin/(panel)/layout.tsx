...
import { getAdminEnvironmentLabel, isAdminPanelEnabled } from '../../../../src/config/feature-flags';
...
export default function AdminPanelLayout({ children, params }: LayoutProps) {
  ...
  return (
    <AdminPanelProviders locale={params.locale} messages={messages} environment={environment}>
